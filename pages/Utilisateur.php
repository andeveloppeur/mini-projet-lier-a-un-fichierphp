        ...
        <form method="POST" action="Utilisateur.php" class="MonForm row insc">
            ...
            <div class="col-md-6 bor">
                ...
                while (!feof($monfichier)) {
                    ...
                    //en cas de bloquage ou de deblocage d'un utilisateur
                    if (isset($_POST[$utilisateurs[1]])) { //vu que les boutons pour bloquer on un name egal au login on cherche si un des bouton a été activé et si le login est different de abdou qui est l admin par defaut
                        if ($utilisateurs[1] != "Abdou") {
                            $changementStat = 1;
                    ...
                    if (isset($_POST["valider"])) {
                        ...
                        if ($utilisateurs[1] == $_POST["login"]) {
                            $existeDeja = 1; //verifie si on a pas le meme login en cas d'ajout (rien à voir avec le bloquage ou le debloquage la même boucle est utiliser pour les 2 traitements)
                        }
                    }
                }
                ...
                if ($nouv != "") {
                    ...
                    fclose($monfichier);
                    header('Location: #' . $aChanger);
                }
                if ($adminprincipal == 1) {
                    header('Location: #Abdou');
                }
                if (isset($_POST["valider"])) {
                    $nom = $_POST["nom"];
                    $login = $_POST["login"];
        ...
        <table class="col-12 tabliste table">
            ...
            while (!feof($monfichier)) {
                ...
                if ($utilisateurs[0] != "") {
                    ...
                    if ($utilisateurs[7] == "Bloquer") {
                        echo "rougMoins";
                    }
                    echo '"name="' . $utilisateurs[1] . '"value="' . $utilisateurs[7] . '" id="' . $utilisateurs[1] . '">
                                </form>
                            </td>
                        </tr>';
                }
